...
from guitar import Guitar, Builder, Type, Wood


def initialize_inventory(inventory):
    ''' set up Rick's guitar inventory '''
    inventory.add_guitar('A4565767', 2541.23, Builder.GIBSON, 'DE-5', Type.ACOUSTIC, Wood.MAHOGANY, Wood.INDIAN_ROSEWOOD)
    inventory.add_guitar('V95693', 1499.95, Builder.FENDER, 'Stratocastor', Type.ELECTRIC, Wood.ALDER, Wood.ALDER)
    inventory.add_guitar('sr112233', 5687.53, Builder.MARTIN, 'mo-98', Type.ELECTRIC, Wood.BRAZILIAN_ROSEWOOD, Wood.ALDER)
